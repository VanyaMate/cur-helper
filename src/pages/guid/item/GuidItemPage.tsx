    ...
    return (
        <Section size={ 'medium' }>
            ...
            <P><strong>Законы</strong> играют важную роль в обществе,
                устанавливая правила и нормы, которые помогают поддерживать порядок и
                защищать права
                граждан.</P>
            <Footnote
                header={ 'Источник' }
                type={ 'notify' }
            >
                Основы права и юриспруденции, учебник для студентов юридических
                специальностей,
                издательство "Юстиция", 2020."
            </Footnote>
            <P>Законы это основа функционирования общества и
                устанавливают
                правила и нормы поведения, которые обеспечивают порядок, защищают права и
                свободы
                граждан, регулируют экономическую деятельность и обеспечивают
                справедливость</P>
            <Footnote
                header={ 'Применение законов' }
                type={ 'warning' }
            >
                При применении законов необходимо учитывать их контекст, а также обращать
                внимание
                на изменяющиеся социальные и экономические условия, чтобы обеспечить их
                справедливое
                применение и эффективное функционирование.
            </Footnote>
            <P>Они также являются основой работы правоохранительных
                органов и судов, обеспечивая соблюдение законов и наказание за их
                нарушение.</P>
            <P>Важность учета гуманитарных аспектов при применении
                законов заключается в необходимости обеспечения справедливости и равенства
                перед
                законом для всех членов общества. Это требует от правоохранительных
                органов,
                судебной системы и законодателей постоянного реагирования на изменяющиеся
                социальные
            ...
            <Footnote
                ...
                type={ 'urgent' }
            >
                Законы - это неизменно важная часть общества, однако их толкование и
                применение
                должно осуществляться с учётом нравственных, этических и гуманитарных
                принципов,
                чтобы обеспечить справедливость и равенство перед законом
            </Footnote>
            <P>Кроме того, правильное толкование законов с учётом
                гуманитарных аспектов способствует укреплению доверия граждан к
                правосудной системе,
                влияя на их легитимность и эффективность. Это также способствует созданию
                более
                здоровой и справедливой социальной среды, где граждане чувствуют себя
                защищёнными и
